// src/components/game/voting/VotingFinalResults.tsx - ИСПРАВЛЕНО
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {eliminated && (
            <>
              <p style={{ fontSize: '18px', margin: '0 0 10px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
                <strong>Исключён:</strong>
                <PlayerAvatar avatarId={eliminated.avatar_id} size="sm" />
                {eliminated.nickname}
              </p>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            {spies.map(spy => (
              <div key={spy.id} style={{ 
                ...
                <PlayerAvatar avatarId={spy.avatar_id} size="sm" />
                {spy.nickname}
              </div>
            ))}
          </div>
